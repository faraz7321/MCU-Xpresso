 ...
 */
void evk_init_ext_osc_clk(void);

/** @brief De-initialize the external PLL oscillator clock.
 */
void evk_deinit_ext_osc_clk(void);
 ...
 */
void evk_init_xtal_clk(void);

/** @brief De-initialize the external XTAL clock.
 */
void evk_deinit_xtal_clk(void);
 ...
 */
void evk_init_usb_clock(void);

/** @brief Select mux PLL 170Mhz input for system clock.
 *
 *  @note This function is made to work in tadem with evk_clk_set_hsi_as_sysclk.
 */
void evk_clock_set_pll_170Mhz_as_sysclk(void);

/** @brief Select mux HSI input for system clock.
 *
 *  @note This function is made to work in tadem with evk_clk_set_pll_170Mhz_as_sysclk.
 */
void evk_clock_set_hsi_as_sysclk(void);

/** @brief Select mux HSI input for system clock and make sure no spi tranfer
 *         are on going.
 *
 ...
 *
 */
void evk_clock_init_rtc_for_wakeup(void);
