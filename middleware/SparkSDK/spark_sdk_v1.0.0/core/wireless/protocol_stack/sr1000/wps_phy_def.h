...
typedef struct phy_frame_cfg {
    ...
    bool fixed_payload_size_enable; /*!< OTA frame size is fixed and known */
    phase_info_t *phase_info;       /*!< Phases informations */
} phy_frame_cfg_t;
...
struct wps_phy {
    ...
    uint8_t *phase_info;      /*!< Radio current phases informations */
