...
static const uint16_t lna_peak_table_sr1010[] = {
    5290 / DCRO_FREQ_RESOLUTION, 4900 / DCRO_FREQ_RESOLUTION, 4510 / DCRO_FREQ_RESOLUTION,
    4240 / DCRO_FREQ_RESOLUTION, 3970 / DCRO_FREQ_RESOLUTION, 3790 / DCRO_FREQ_RESOLUTION,
    3610 / DCRO_FREQ_RESOLUTION, 3460 / DCRO_FREQ_RESOLUTION
};
static const uint16_t lna_peak_table_sr1020[] = {
    8840 / DCRO_FREQ_RESOLUTION, 8420 / DCRO_FREQ_RESOLUTION, 8000 / DCRO_FREQ_RESOLUTION,
    7700 / DCRO_FREQ_RESOLUTION, 7340 / DCRO_FREQ_RESOLUTION, 7040 / DCRO_FREQ_RESOLUTION,
    6800 / DCRO_FREQ_RESOLUTION, 6620 / DCRO_FREQ_RESOLUTION
};
...
uint8_t sr_calib_tune_delay_line(radio_t *radio)
{
    ...
    uwb_set_dll_tuning(radio,  SET_DLLTUNING(DLL_TUNING_CLEAR,
                                             DLTUNE_RAW_TO_REG(dl_tune),
                                             ECO_ENABLE,
                                             INTEGGAIN_RAW_TO_REG(0b01)));
