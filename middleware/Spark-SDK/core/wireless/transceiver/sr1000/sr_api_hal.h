...
typedef struct {
    ...
    void (*transfer_full_duplex_blocking)
        (uint8_t *tx_data, uint8_t *rx_data, uint16_t size); /*!< SPI Transfer full duplex in blocking mode.
    ...
    void (*transfer_full_duplex_non_blocking)
        (uint8_t *tx_data, uint8_t *rx_data, uint16_t size); /*!< SPI Transfer full duplex in non blocking mode using DMA.
                                                                  Spark Radio only support full duplex on instructions
                                                                  actual read and write are always in half-duplex mode.
