/** @file  audio_sinus.h
 *  @brief Audio endpoint used to produce a pre-recorded sine wave.
 *
 ...
 */
#ifndef AUDIO_SINUS_H_
#define AUDIO_SINUS_H_
...
typedef enum sine_freq {
    SINE_FREQ_1K,      /* 1 period of a 1 kHz tone sampled at 48 kHz, 16-bit samples, mono */
    SINE_FREQ_2K,      /* 2 periods of a 2 kHz tone sampled at 48 kHz, 16-bit samples, mono */
    SINE_FREQ_3K       /* 3 periods of a 3 kHz tone sampled at 48 kHz, 16-bit samples, mono */
} sine_freq_t;

/** @brief Sinus Endpoint Instance.
 */
typedef struct sinus_instance {
    sine_freq_t sine_freq; /*!< Frequency of the produced sine wave */
} sinus_instance_t;
