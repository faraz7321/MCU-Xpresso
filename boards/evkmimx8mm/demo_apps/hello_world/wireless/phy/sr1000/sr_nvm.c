...
static nvm_entry_t nvm_template[NVM_KEY_LAST - 1] = {
    ...
    {NVM_KEY_CALIBRATION, NVM_KEY_CALIBRATION_NAME, 1, NULL},
    {NVM_KEY_WIDTH_FREQ,  NVM_KEY_WIDTH_FREQ_NAME,  1, NULL},
    {NVM_KEY_FREQ_TICKS,  NVM_KEY_FREQ_TICKS_NAME,  1, NULL},
    {NVM_KEY_WAFER_LOT,   NVM_KEY_WAFER_LOT_NAME,   3, NULL},
    {NVM_KEY_TEST_DATE,   NVM_KEY_TEST_DATE_NAME,   3, NULL},
    {NVM_KEY_TP_VERSION,  NVM_KEY_TP_VERSION_NAME,  2, NULL},
    {NVM_KEY_REG_CORNER,  NVM_KEY_REG_CORNER_NAME,  1, NULL},
    {NVM_KEY_PRODUCT_ID,  NVM_KEY_PRODUCT_ID_NAME,  2, NULL},
    {NVM_KEY_VCRO_SHIFT,  NVM_KEY_VCRO_SHIFT_NAME,  2, NULL},
